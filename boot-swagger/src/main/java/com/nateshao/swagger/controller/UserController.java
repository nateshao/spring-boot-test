...
import com.nateshao.swagger.common.ApiResponse;
import com.nateshao.swagger.common.DataType;
import com.nateshao.swagger.common.ParamType;
import com.nateshao.swagger.entity.User;
...
@RestController
@RequestMapping("/user")
@Api(tags = "1.0.0-SNAPS    HOT", description = "用户管理", value = "用户管理")
@Slf4j
